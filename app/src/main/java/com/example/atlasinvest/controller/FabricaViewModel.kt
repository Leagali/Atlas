...
/**
 * Fábrica responsável por criar as ViewModels do app.
 */
class FabricaViewModel(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            MovimentacaoViewModel(usuarioId, app.movimentacaoRepository, app.metaRepository) as T

            modelClass.isAssignableFrom(MetaViewModel::class.java) ->
            MetaViewModel(usuarioId, app.metaRepository) as T
