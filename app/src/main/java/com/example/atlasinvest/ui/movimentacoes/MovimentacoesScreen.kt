...
fun MovimentacoesScreen(app: AtlasInvestApplication, usuarioId: Long, navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // Seção de título com ícone de histórico
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp),
            ...
            Column {
                Row(
                    ...
                    Button(
                        ...
                        colors = if (tipoSelecionado == TipoMovimentacao.RECEITA) 
                            ButtonDefaults.buttonColors(containerColor = VerdeReceita) 
                    ...
                    Button(
                        ...
                        modifier = Modifier.weight(1f),
                        colors = if (tipoSelecionado == TipoMovimentacao.DESPESA) 
